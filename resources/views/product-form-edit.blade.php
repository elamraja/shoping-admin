...
@section('main-content')
    <div class="cust_card">
        ...
        <div class="body">
            {{ FORM::open(['url'=>'products/update/'.$product->id,'method'=>'post','enctype'=>'multipart/form-data']) }}
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-3">
                    <div class="form-group {{ $errors->has('price') ? 'has-error': '' }}">
                        ...
                        {{ FORM::text('price',$product->price,['class'=>'form-control','placeholder'=>'Prroduct Price']) }}
                        @if($errors->has('price'))
                ...
                <div class="col-md-3">
                    <div class="form-group {{ $errors->has('qty') ? 'has-error': '' }}">
                        ...
                        {{ FORM::text('qty',$product->stock,['class'=>'form-control','placeholder'=>'Prroduct Stock']) }}
                        @if($errors->has('qty'))
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group {{ $errors->has('description') ? 'has-error': '' }}">
                        ...
                        {{ FORM::textarea('description',$product->description,['class'=>'form-control','rows'=>'10']) }}
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('image') ? 'has-error': '' }}">
                        ...
                        <div class="image_upload">
                            ...
                            <img id="image" src="{{ URL::asset('uploads/products/'.$product->id.'.jpg') }}" class="preview_image" style="display: block;"/>
                        </div>
                        @if($errors->has('image'))
